...
* link:doc/index.txt[Goals]
* link:doc/standards.txt[Some notes on Code Standards]
* link:doc/glossary.txt[Glossary]
* link:doc/data_source_interface.txt[Data Source Interface]
* link:doc/data_source_interface.txt[]
